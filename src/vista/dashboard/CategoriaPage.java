...
public class CategoriaPage extends javax.swing.JPanel {
    ...
    public CategoriaPage(javax.swing.JFrame parent) {
        ...
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new TableButtonCellRenderer());
        jTable1.getColumnModel().getColumn(3).setMaxWidth(120); // Establece el ancho máximo de la columna "Acciones"
