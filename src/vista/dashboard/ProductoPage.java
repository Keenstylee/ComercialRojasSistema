...
import dialogModals.AddCategoriaModal;
...
public class ProductoPage extends javax.swing.JPanel {
    ...
    public ProductoPage(javax.swing.JFrame parent) {
        ...
        jTable1.getColumnModel().getColumn(6).setCellRenderer(new TableButtonCellRenderer());
        jTable1.getColumnModel().getColumn(6).setMaxWidth(120); // Establece el ancho máximo de la columna "Acciones"
    ...
    private void OpenModalButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OpenModalButtonActionPerformed
        ...
        AddCategoriaModal dialog = new AddCategoriaModal(parent, true);
