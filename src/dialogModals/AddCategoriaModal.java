...
import components.TableButtonCellRenderer;
 ...
 * @author intel
 */
public class AddCategoriaModal extends javax.swing.JDialog {

    /**
     * Creates new form AddCategoriaModal
     */
    public AddCategoriaModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!nombre.isEmpty() && !descripcion.isEmpty()){
            ...
            if(CategoriaControlador.crearCategoria(categoria)){
                ...
                // Actualiza la tabla de categorías en la página de categorías con los nuevos datos
                CategoriaPage.jTable1.setModel(CategoriaPage.cargarTablaCategorias());
                // Configura el renderizador de celdas para la columna "Acciones"
                CategoriaPage.jTable1.getColumnModel().getColumn(3).setCellRenderer(new TableButtonCellRenderer());
                // Establece el ancho máximo de la columna "Acciones"
                CategoriaPage.jTable1.getColumnModel().getColumn(3).setMaxWidth(120);
                // Establece el ancho máximo de la columna "Id"
                CategoriaPage.jTable1.getColumnModel().getColumn(0).setMaxWidth(50);
                // Establece la altura de las filas de la tabla
                CategoriaPage.jTable1.setRowHeight(30);
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddCategoriaModal dialog = new AddCategoriaModal(new javax.swing.JFrame(), true);
